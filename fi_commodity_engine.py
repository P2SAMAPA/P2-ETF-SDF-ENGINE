# =============================================================================
# FI/Commodity Engine Module - Fixed Income & Commodity ETF Signal Generation
# =============================================================================
"""
SDF Engine for Fixed Income and Commodity ETFs.
Uses AGG as benchmark for performance comparison.
"""
...
class FICommodityEngine:
    """Signal generation engine for FI/Commodity ETFs."""

    def __init__(self, hf_token: Optional[str] = None):
        """
        Initialize FI/Commodity Engine.

        Args:
            hf_token: HuggingFace token
        """
        self.assets = CONFIG['universes']['fi_commodities']['assets']
        self.benchmark = CONFIG['universes']['fi_commodities']['benchmark']
        self.name = CONFIG['universes']['fi_commodities']['name']
    ...
    def fit(self, train_returns: pd.DataFrame, train_macro: pd.DataFrame) -> 'FICommodityEngine':
        """
        ...
        print(f"FI/Commodity: Extracted {self.pca_.optimal_k_} factors")
    ...
    def run_historical_signals(
        ...
        for i, date in enumerate(dates):
            if i % 50 == 0:
                print(f"FI/Commodity: {date.date()} ({i+1}/{len(dates)})")
